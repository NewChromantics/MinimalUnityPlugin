...
GCC_PREPROCESSOR_DEFINITIONS += FILLER_123456789
...
#	gr: use static instead of shared so we dont have a dependency on c++shared.so
#		but we have to be careful that all other static libs have the exact same stl version
#APP_STL := c++_shared
APP_STL := c++_static
...
APP_MODULES += $(PRODUCT_NAME)_Shared
APP_MODULES += $(PRODUCT_NAME)_TestApp
